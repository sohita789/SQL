...
USE scam_info;
CREATE TABLE scam_info(id int,scam_type VARCHAR(50), scam_date int, scam_amount int,victim_name VARCHAR(30),victim_contact int,victim_address varchar(50),perpetrator_name VARCHAR(30),perpetrator_contact VARCHAR(20),perpetrator_address varchar(30))
...
UPDATE scam_info SET victim_contact=852369743  WHERE id=10;
UPDATE scam_info SET report_date=07032010 WHERE id=2;
